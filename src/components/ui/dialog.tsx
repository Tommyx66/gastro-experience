...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "mt-2 flex flex-col-reverse gap-2 border-t border-[var(--color-border)] pt-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "text-lg font-medium leading-none text-[var(--color-text)]",
        className
      )}
      {...props}
    />
